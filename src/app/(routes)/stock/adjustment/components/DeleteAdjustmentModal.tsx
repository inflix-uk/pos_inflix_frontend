...
interface DeleteAdjustmentModalProps {
 open: boolean;
 onClose: () => void;
 onDelete: () => void;
}

export const DeleteAdjustmentModal: React.FC<DeleteAdjustmentModalProps> = ({
 open,
 onClose,
 onDelete,
}) => {
 ...
 <div className="flex flex-col items-center">
  ...
  <h2 className="text-xl font-semibold mb-2">Delete Adjustment</h2>
