...
export const CategoryHeader: React.FC<CategoryHeaderProps> = ({
 ...
 <div className="min-w-0">
  <h1 className="text-lg @[640px]:text-2xl font-semibold text-gray-900">Category</h1>
  <p className="text-[11px] @[640px]:text-base text-gray-600 mt-0.5 @[640px]:mt-1">Manage your categories</p>
 </div>
 <div className="flex flex-wrap items-center gap-1.5 @[640px]:gap-3">
  ...
  <span className="hidden @[420px]:inline">Add Category</span>
