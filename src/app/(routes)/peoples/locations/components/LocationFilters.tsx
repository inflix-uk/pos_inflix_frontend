...
interface LocationFiltersProps {
 ...
 onTypeFilter: (type: "all" | "store" | "warehouse") => void;
 onSortChange: (sort: string) => void;
 statusFilter: "all" | "active" | "inactive";
 typeFilter: "all" | "store" | "warehouse";
 sortBy: string;
}
...
export const LocationFilters: React.FC<LocationFiltersProps> = ({
 ...
 const currentTypeLabel = typeOptions.find(t => t.value === typeFilter)?.label || "All Types";
 ...
 <div className="relative">
  ...
  {typeOptions.map((option) => (
   ...
   onClick={() => {
   onTypeFilter(option.value as "all" | "store" | "warehouse");
