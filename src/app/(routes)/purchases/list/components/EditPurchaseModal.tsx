...
interface EditPurchaseModalProps {
 ...
 onClose: () => void;
 onUpdate: (id: string, data: Partial<PurchaseFormData>) => void;
 isLoading: boolean;
}
...
export const EditPurchaseModal: React.FC<EditPurchaseModalProps> = ({
 ...
 if (purchase) {
 setFormData({
 supplierName: typeof purchase.supplier === 'string' ? purchase.supplier : purchase.supplier?.name || "",
 ...
 e.preventDefault();
 if (purchase) {
 onUpdate(purchase._id, formData);
 }
 };
 ...
 <div className="flex items-center justify-between p-6 border-b border-gray-200">
  <h2 className="text-xl font-semibold text-gray-800">Edit Purchase</h2>
  <button
  onClick={onClose}
 ...
 <form onSubmit={handleSubmit} className="p-6 space-y-6">
  ...
  />
  <datalist id="products-list-edit">
