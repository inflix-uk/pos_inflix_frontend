...
export const DeleteReturnModal: React.FC<DeleteReturnModalProps> = ({
 open,
 onClose,
 onDelete,
 purchaseReturn,
 ...
 <div className="p-6">
  ...
  <span className="font-medium">{purchaseReturn.returnNumber}</span>
  {purchaseReturn.supplierName ? ` — ${purchaseReturn.supplierName}` : ""}
  </p>
