...
export const DeleteConfirmModal: React.FC<DeleteConfirmModalProps> = ({
 ...
 <div className="flex items-center gap-3 mb-4">
  ...
  <h3 className="text-lg font-semibold text-gray-800">Delete Email Settings</h3>
 </div>
 <p className="text-gray-600 mb-6">
  Are you sure you want to delete all email settings? This will disable all email functionality until reconfigured.
 </p>
