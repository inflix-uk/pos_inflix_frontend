...
interface DeleteSalesReturnModalProps {
  open: boolean;
  onClose: () => void;
  onDelete: () => void;
  reference?: string;
...
const DeleteSalesReturnModal: React.FC<DeleteSalesReturnModalProps> = ({
  open,
  onClose,
  onDelete,
  reference,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#e0dff091] bg-opacity-40">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md mx-2 p-8 relative text-center">
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-xl font-semibold mb-2">Delete Sales Return</h2>
          <p className="mb-6 text-gray-700">
            Are you sure you want to delete {reference ? `sales return ${reference}` : 'this sales return'}? This action cannot be undone.
          </p>
...
export default DeleteSalesReturnModal;
