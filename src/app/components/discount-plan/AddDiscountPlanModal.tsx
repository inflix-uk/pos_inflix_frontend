...
interface AddDiscountPlanModalProps {
  open: boolean;
  onClose: () => void;
  onAdd: (discountPlan: DiscountPlan) => void;
}

const AddDiscountPlanModal: React.FC<AddDiscountPlanModalProps> = ({
  open,
  onClose,
  onAdd,
}) => {
  ...
  const handleSubmit = () => {
    ...
    const newDiscountPlan: DiscountPlan = {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#e0dff091] bg-opacity-50">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Add Discount Plan</h2>
          <button
            onClick={onClose}
