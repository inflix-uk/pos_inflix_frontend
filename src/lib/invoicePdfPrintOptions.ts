...
export const DEFAULT_INVOICE_PDF_PRINT: InvoicePdfPrintOptions = {
  ...
  marginMm: 18,
  fontCompanyNamePt: 18,
  fontDocTitlePt: 14,
  fontSectionHeadingPt: 10,
  fontBodyPt: 10,
  fontTablePt: 8,
  fontTermsPt: 8,
  logoWidthMm: 32,
...
export function mergeInvoicePdfPrintOptions(
  ...
  return {
    ...
    fontCompanyNamePt: clamp(p.fontCompanyNamePt ?? d.fontCompanyNamePt, 14, 24, d.fontCompanyNamePt),
    fontDocTitlePt: clamp(p.fontDocTitlePt ?? d.fontDocTitlePt, 11, 20, d.fontDocTitlePt),
    fontSectionHeadingPt: clamp(p.fontSectionHeadingPt ?? d.fontSectionHeadingPt, 8, 14, d.fontSectionHeadingPt),
    fontBodyPt: clamp(p.fontBodyPt ?? d.fontBodyPt, 8, 13, d.fontBodyPt),
    fontTablePt: clamp(p.fontTablePt ?? d.fontTablePt, 7, 11, d.fontTablePt),
    fontTermsPt: clamp(p.fontTermsPt ?? d.fontTermsPt, 7, 11, d.fontTermsPt),
